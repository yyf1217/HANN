import torch
from src.utils_add import *
from src.model_fuse_5d import *
...
parser.add_argument("--outdir", type=str, default="result_count_fuse_5d_2", help="output")
...
pt_dir = 'data/count/processed_5d/{}_{}.pt'.format(args.task[0], args.task[1])
